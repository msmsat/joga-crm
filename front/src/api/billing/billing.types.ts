...
export interface BillingPlan {
  ...
  /** Открыта ли ещё акция «N дней бесплатно». Считает сервер тем же правилом,
 ...
 *  окне. Меняете там — поменяйте и тут, и в локалях лендинга: расхождение
 *  роняет back/tests/test_trial_days_sync.py. */
