...
const QA: [string, string][] = [
  ...
  ["Можно вести несколько студий или филиалов?",
   "Да. Один аккаунт может состоять в нескольких студиях с переключением между ними, а внутри студии заводятся филиалы и залы. Мультифилиальность на тарифе Business."],
  ["Есть тёмная тема и другие языки?",
   "Да, интерфейс переключается между светлой и тёмной темой и поддерживает несколько языков. Часовой пояс, валюта и язык задаются при онбординге."],
  ["Что будет с данными, если я решу уйти?",
   "Данные ваши. В настройках есть экспорт и резервные копии, а удаление выполняется по вашему запросу."],
];
