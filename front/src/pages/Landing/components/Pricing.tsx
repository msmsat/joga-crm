...
// (цены в центах EUR: 3900 / 9900 / 23900; лимиты staff, clients, ai_requests).
// Витрина здесь статическая, в кабинете каталог приходит с сервера — при смене
// цен правим оба места. Раньше тут стояли рубли (990 / 2 490 / 5 990 ₽) и
// список фич, которых в продукте нет: White-label, API, SLA, выделенный
// менеджер. Обещать их со страницы, где рядом кнопка оплаты, нельзя.
const MODELS = [
  { title: "Подписка", price: "от 39 € / мес", desc: "Фиксированная сумма. Знаете расход заранее — никаких сюрпризов в конце месяца." },
  { title: "3% с выручки", price: "минимум 39 € / мес", desc: "Платите с оборота. В пустой месяц доплачиваете только разницу до минимума." },
  { title: "Комбо", price: "½ фикса + 1.5%", desc: "Половина подписки плюс небольшой процент — компромисс между двумя моделями." },
];

const PLANS = [
  {
    id: "start", name: "Старт", price: "39", accent: false,
    for: "Одиночная студия, которая только запускается",
    features: ["До 3 сотрудников", "До 100 клиентов", "300 AI-обращений в месяц", "Все 16 модулей"],
  },
  {
    id: "pro", name: "Pro", price: "99", accent: true,
    for: "Растущая студия с командой и постоянным потоком",
    features: ["До 15 сотрудников", "До 1000 клиентов", "1500 AI-обращений в месяц", "Все 16 модулей"],
  },
  {
    id: "business", name: "Business", price: "239", accent: false,
