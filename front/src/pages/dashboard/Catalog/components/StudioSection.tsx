    ...
    <div className="cat-layout">
      ...
      <div className="cat-list-panel">
        ...
        <div className="cat-list">
          {isLoading ? null : groups.map(group => (
            <div key={group.label}>
          ...
          <>
            <div className="cat-hero">
              ...
              <div className="cat-hero-actions">
                ...
                <button className="cat-h-btn del" onClick={handleDeleteStudio}>
              ...
              {activeHall === null ? (
                ...
                <>
                  ...
                  <div className="cat-info-row">
                    {activeStudio.phone && (
                      <div className="cat-chip clickable" onClick={() => showToast(t('common:toasts.phoneCopied'))}>
                    ...
                    {activeStudio.email && (
                      <div className="cat-chip clickable" onClick={() => showToast(t('common:toasts.emailCopied'))}>
                  ...
                  <div className="cat-stats-row" style={{ gridTemplateColumns: 'repeat(3, 1fr)', marginTop: '16px' }}>
                    ...
                    <div className="cat-stat-card">
                      <div className="cat-stat-v">
                        {minHourlyRate != null ? `₽${(minHourlyRate / 1000).toFixed(1)}K` : '—'}
                      </div>
                    ...
                    {activeStudio.halls.map(hall => (
                      <div key={hall.id} className="cat-hall-card" onClick={() => setActiveHallId(hall.id)}>
                        ...
                        <div className="cat-hall-price">
                          {hall.hourly_rate != null ? `₽${hall.hourly_rate.toLocaleString()}${t('common:units.perHour')}` : '—'}
                        </div>
                ...
                <div className="cat-fade" key={activeHallId}>
                  <div className="cat-stats-row" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                    ...
                    <div className="cat-stat-card">
                      <div className="cat-stat-v">
                        {activeHall.hourly_rate != null ? `₽${activeHall.hourly_rate.toLocaleString()}` : '—'}
                      </div>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <button className="cat-action-btn del" onClick={handleDeleteHall}>
