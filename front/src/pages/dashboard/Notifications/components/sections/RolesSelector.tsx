        ...
        return (
          ...
          >
            ...
            <div style={{ flex: 1, overflow: 'hidden' }}>
              <div style={{ fontSize: '14px', fontWeight: 800, color: isActive ? 'var(--onyx)' : 'var(--muted)', lineHeight: 1.2, whiteSpace: 'nowrap', textOverflow: 'ellipsis', transition: 'color 0.2s ease' }}>
                {t(`roles.${role.key}`)}
              </div>
              <div style={{ fontSize: '11px', color: isActive ? role.color : 'var(--text3)', marginTop: '3px', fontWeight: 600, transition: 'color 0.25s ease' }}>
