...
/** Тот же предел, что на бэке (_MAX_COFFEE_SPOTS в schemas/settings/booking.py). */
const MAX_SPOTS = 5
 ...
 * с группой, и в самом приглашении видит места из этого списка. Согласились
 * двое и больше — после занятия им придёт напоминание с именами и местами.
 *
 * Пустой список выключает механику целиком (BookingRules.coffee_live): звать
 * остаться, не имея что предложить, — половина приглашения.
 *
