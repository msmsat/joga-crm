...
export function BookingChannels({ onOpenTg, onOpenInsta, onOpenWeb, onOpenWa }: Props) {
  return (
    <div style={{ marginBottom: '28px' }}>
      ...
      <div className="channels-grid">
        <ChannelCard icon={<IconTelegram />}  name="Telegram-бот" desc="Автоматическая запись через бота"  status={null}        color="#4A80C4" onClick={onOpenTg} />
