...
// AI-строка делит открытый диалог с дровером (эпик AI-1, задача 7): вопрос
// отсюда продолжает ту же сессию, которую откроет «продолжить в чате». У
// страницы AI диалог свой — она ведёт и запоминает его отдельно.
