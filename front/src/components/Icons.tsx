...
export const QrCode = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M14 14h3v3h-3zM18 18h3v3h-3zM14 21h0.01M21 14h0.01"/>
  </svg>
);
...
// ─── ИКОНКИ ЛЕНДИНГА (LANDING / MARKETING) ──────────────────────────────────
...
export const ChatBubble = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const Dumbbell = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <rect x="6" y="7.5" width="2.5" height="9" rx="1" />
    <rect x="15.5" y="7.5" width="2.5" height="9" rx="1" />
...
export const Comb = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <rect x="4" y="4" width="16" height="3" rx="1" />
    <line x1="6.5" y1="7" x2="6.5" y2="19" />
    <line x1="10" y1="7" x2="10" y2="16" />
    <line x1="13.5" y1="7" x2="13.5" y2="19" />
    <line x1="17.5" y1="7" x2="17.5" y2="16" />
  </svg>
);

export const Sparkle = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" {...props}>
