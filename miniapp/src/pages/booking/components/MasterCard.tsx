 ...
 * «ещё N»: полный список человек увидит в листе, одним касанием. В чипе стоит
 * цена ЭТОГО мастера: здесь он уже известен, и диапазона «от–до» тут не бывает.
 *
              ...
              {pills.shown.map((service) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Цена ЭТОГО мастера прямо в чипе: карточка существует,
                        чтобы выбрать человека, а у одной услуги у разных
                        мастеров цена своя — без неё выбор делается вслепую. */}
                    {member.service_price_strs?.[service.id] && (
