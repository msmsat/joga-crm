...
export default function App() {
  ...
  // готовых данных, повторного запроса к серверу и повторного проигрыша всех
  ...
  // после эффекта, иначе первое открытие вкладки даёт кадр пустоты.
  if (!visited.includes(screenTab)) setVisited([...visited, screenTab]);
