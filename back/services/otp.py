...
_SUBJECTS = {
    ...
    "delete_user": {"ru": "Код для удаления аккаунта Velora", "en": "Velora account deletion code",
                    "uk": "Код для видалення акаунта Velora", "cs": "Kód pro smazání účtu Velora",
                    "de": "Velora Code zum Löschen des Kontos"},
...
_PURPOSE = {
    ...
    "delete_user": {"ru": "удалить ваш аккаунт навсегда", "en": "permanently delete your account",
                    "uk": "назавжди видалити ваш акаунт", "cs": "trvale smazat váš účet",
                    "de": "Ihr Konto endgültig löschen"},
