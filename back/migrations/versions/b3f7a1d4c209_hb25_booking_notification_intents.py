...
Родитель — `d1c4e8b70a35` (расширение provider_message_id), а не `6cdd4f27a359`:
параллельная сессия завела свою ревизию от того же родителя, и две головы
не сошлись бы сами. Перецепление СВОЕЙ ревизии предпочтительнее merge-узла:
ни одна из двух ещё не применена (dev-база стоит на `f061d8187ad4`, тестовая
собирается из моделей), поэтому линейная история честнее развилки со швом.
"""
import sqlalchemy as sa
from alembic import op

revision = "b3f7a1d4c209"
down_revision = "d1c4e8b70a35"
branch_labels = None
depends_on = None
